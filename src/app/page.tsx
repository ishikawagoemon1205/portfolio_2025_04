    ...
    <div className="relative min-h-screen " style={{
      ...
      <div className="">
        <div className="w-screen h-screen flex items-center justify-center">
          <div ref={Page1_ref} className="w-[1024px] h-[100%] ">
            <HomePage1/>
          </div>
        </div>
        <div className="w-screen h-screen flex items-center justify-center">
          <div ref={Page2_ref} className="w-[1024px] h-[100%] ">
            <HomePage2/>
          </div>
        </div>
        <div className="w-screen h-screen flex items-center justify-center">
          <div ref={Page3_ref} className="w-[1024px] h-[100%] ">
            <HomePage3/>
          </div>
        </div>
        <div className="w-screen h-screen flex items-center justify-center">
          <div ref={Page4_ref} className="w-[1024px] h-[100%] ">
            <HomePage4/>
          </div>
        </div>
        <div className="w-screen h-screen flex items-center justify-center">
          <div ref={Page5_ref} className="w-[1024px] h-[100%] ">
            <HomePage5/>
          </div>
        </div>
        <div className="w-screen h-screen flex items-center justify-center">
          <div ref={Page6_ref} className="w-[1024px] h-[100%] ">
            <HomePage6/>
          </div>
        </div>
        <div className="w-screen h-screen flex items-center justify-center">
          <div ref={Page7_ref} className="w-[1024px] h-[100%] ">
            <HomePage7/>
          </div>
        </div>
        <div className="w-screen h-screen flex items-center justify-center">
          <div ref={Page11_ref} className="w-[1024px] h-[100%] ">
            <HomePage11/>
          </div>
        </div>
