    ...
    return(
        <>
            ...
            <div className="w-full h-[calc(100%-100px)] space-y-[5px]">
                <p className="text-[50px]">Background & Journey</p>
                <p className="text-[22px]">
                    While studying architecture in university, I founded my first business in 2020 driven by a strong desire to "achieve something only I can do, in the most efficient way." I launched a customer referral service that gained traction and even won a business competition.
